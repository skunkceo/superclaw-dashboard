...
const SEARCH_QUERIES: Array<{ query: string; category: IntelItem['category']; source: string }> = [
  // WordPress CRM & forms market
  { query: 'WordPress CRM plugin news 2025 2026', category: 'market', source: 'brave' },
  { query: 'WordPress forms plugin update release', category: 'market', source: 'brave' },
  { query: 'small business WordPress plugins trending', category: 'market', source: 'brave' },
  // Competitor moves
  { query: 'WPForms new features update 2026', category: 'competitor', source: 'brave' },
  { query: 'Gravity Forms update announcement', category: 'competitor', source: 'brave' },
  { query: 'HubSpot WordPress plugin news', category: 'competitor', source: 'brave' },
  { query: 'FluentCRM update features 2026', category: 'competitor', source: 'brave' },
  // SEO opportunities
  { query: 'WordPress CRM plugin comparison', category: 'seo', source: 'brave' },
  { query: 'best WordPress contact form plugin', category: 'seo', source: 'brave' },
  // Opportunities
  { query: 'WordPress plugin market growth 2026', category: 'opportunity', source: 'brave' },
  { query: 'small business CRM software alternatives', category: 'opportunity', source: 'brave' },
  // WordPress ecosystem
  { query: 'WordPress developer news this week', category: 'wordpress', source: 'brave' },
  { query: 'WordPress plugin business revenue strategy', category: 'wordpress', source: 'brave' },
];
