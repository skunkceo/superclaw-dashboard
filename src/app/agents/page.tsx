...
function AgentCard({ agent, session }: { agent: Agent; session?: AgentSession }) {
  ...
  return (
    ...
    >
      ...
      {/* Hover info panel */}
      {hovered && (
        <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 z-[60] w-72 max-h-72 overflow-y-auto bg-zinc-800 border border-zinc-700 rounded-xl shadow-2xl p-4 pointer-events-none">
