            ...
            <>
              ...
              <div className="flex-1 p-6 relative">
                ...
                <textarea
                  ...
                  className="w-full h-full bg-zinc-900/50 border border-zinc-700 rounded-lg p-4 text-white font-mono text-sm resize-none focus:border-orange-500 focus:outline-none"
